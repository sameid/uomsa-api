...
if (typeof jQuery === 'undefined') { throw new Error('Bootstrap\'s JavaScript requires jQuery') ***REMOVED***
...
+function ($) {
  ...
  ***REMOVED***
  ...
  Tooltip.prototype.getPosition = function ($element) {
    ...
    return $.extend({***REMOVED***, (typeof el.getBoundingClientRect == 'function') ? el.getBoundingClientRect() : null, {
      scroll: isBody ? document.documentElement.scrollTop || document.body.scrollTop : $element.scrollTop(),
      width:  isBody ? $(window).width()  : $element.outerWidth(),
      height: isBody ? $(window).height() : $element.outerHeight()
    ***REMOVED***, isBody ? { top: 0, left: 0 ***REMOVED*** : $element.offset())
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  Tooltip.prototype.getViewportAdjustedDelta = function (placement, pos, actualWidth, actualHeight) {
    ...
    ***REMOVED*** else {
      ...
      ***REMOVED*** else if (rightEdgeOffset > viewportDimensions.width) { // right overflow
