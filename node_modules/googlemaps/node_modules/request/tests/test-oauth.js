...
var reqsign = hmacsign('POST', 'https://api.twitter.com/oauth/request_token', 
  ...
  , oauth_version: '1.0'
  ***REMOVED***, "MCD8BKwGdgPHvAuvgvz4EQpqDAtx89grbuNMRd7Eh98")
...
var accsign = hmacsign('POST', 'https://api.twitter.com/oauth/access_token',
  ...
  , oauth_version: '1.0'
  ***REMOVED***, "MCD8BKwGdgPHvAuvgvz4EQpqDAtx89grbuNMRd7Eh98", "x6qpRnlEmW9JbQn4PQVVeVG8ZLPEx6A0TOebgwcuA")
...
var upsign = hmacsign('POST', 'http://api.twitter.com/1/statuses/update.json', 
  ...
  ***REMOVED***, "MCD8BKwGdgPHvAuvgvz4EQpqDAtx89grbuNMRd7Eh98", "J6zix3FfA9LofH0awS24M3HcBYXO5nI1iYe8EfBA")
...
var r = request.post(
  ...
  , oauth: 
    ...
    ***REMOVED***
  , form: {status: 'setting up my twitter 私のさえずりを設定する'***REMOVED*** 
  ***REMOVED***)
