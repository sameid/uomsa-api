 ...
 *
 * @param {String|Function|Object***REMOVED*** format or options
...
exports = module.exports = function logger(options) {
  if (options && typeof options !== 'object') {
    options = { format: options ***REMOVED***;
  ***REMOVED*** else {
  ...
  ***REMOVED***
  ...
  var skip = options.skip || function () { return false; ***REMOVED***;
...
function compile(fmt) {
  fmt = fmt.replace(/"/g, '\\"');
  var js = '  return "' + fmt.replace(/:([-\w]{2,***REMOVED***)(?:\[([^\]]+)\])?/g, function(_, name, arg){
 ...
 * @return {Object***REMOVED*** exports for chaining
 * @api public
 */
 ...
 *
 * @param {String***REMOVED*** name
 * @param {String|Function***REMOVED*** fmt
 * @return {Object***REMOVED*** exports for chaining
 * @api public
 */
...
exports.token('res', function(req, res, field){
  return (res._headers || {***REMOVED***)[field.toLowerCase()];
***REMOVED***);
