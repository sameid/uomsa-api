...
function RedisClient(stream, options) {
    ...
    ***REMOVED***
    ...
    this.subscription_set = {***REMOVED***;
    this.monitoring = false;
    this.closing = false;
    this.server_info = {***REMOVED***;
    this.auth_pass = null;
    ...
    self.send_command("auth", [this.auth_pass], function (err, res) {
        if (err) {
            if (err.toString().match("LOADING")) {
                ...
                setTimeout(function () {
                    self.do_auth();
                ***REMOVED***, 2000); // TODO - magic number alert
                return;
            ***REMOVED*** else if (err.toString().match("no password is set")) {
...
RedisClient.prototype.on_ready = function () {
    ...
    ***REMOVED***
    if (this.pub_sub_mode === true) {
        ...
        ***REMOVED***);
        return;
    ***REMOVED*** else if (this.monitoring) {
...
RedisClient.prototype.on_info_cmd = function (err, res) {
    var self = this, obj = {***REMOVED***, lines, retry_time;
...
RedisClient.prototype.return_reply = function (reply) {
    ...
    ***REMOVED***
    ...
    if (command_obj && !command_obj.sub_command) {
        ...
        ***REMOVED*** else if (exports.debug_mode) {
            console.log("no callback for reply: " + (reply && reply.toString && reply.toString()));
        ***REMOVED***
    ***REMOVED*** else if (this.pub_sub_mode || (command_obj && command_obj.sub_command)) {
        if (Array.isArray(reply)) {
            type = reply[0].toString();

            if (type === "message") {
                this.emit("message", reply[1].toString(), reply[2]); // channel, message
            ***REMOVED*** else if (type === "pmessage") {
                this.emit("pmessage", reply[1].toString(), reply[2].toString(), reply[3]); // pattern, channel, message
            ***REMOVED*** else if (type === "subscribe" || type === "unsubscribe" || type === "psubscribe" || type === "punsubscribe") {
                if (reply[2] === 0) {
                    this.pub_sub_mode = false;
                    if (this.debug_mode) {
...
RedisClient.prototype.send_command = function (command, args, callback) {
    ...
    ***REMOVED*** else if (command === "monitor") {
        this.monitoring = true;
    ***REMOVED*** else if (command === "quit") {
        this.closing = true;
    ***REMOVED*** else if (this.pub_sub_mode === true) {
...
RedisClient.prototype.end = function () {
    ...
    if(this.retry_timer){
        ...
        this.retry_timer=null;
    ***REMOVED***
    this.stream.on("error", function(){***REMOVED***);
...
RedisClient.prototype.hmget = function (arg1, arg2, arg3) {
    ...
    ***REMOVED*** else if (Array.isArray(arg1) && typeof arg2 === "function") {
...
exports.createClient = function(arg0, arg1, arg2){
    if( arguments.length === 0 ){
        ...
        // createClient()
        return createClient_tcp(default_port, default_host, {***REMOVED***);

    ***REMOVED*** else if( typeof arg0 === 'number' ||
...
var createClient_unix = function(path, options){
    ...
    ***REMOVED***;
    ...
    var redis_client = new RedisClient(net_client, options || {***REMOVED***);
