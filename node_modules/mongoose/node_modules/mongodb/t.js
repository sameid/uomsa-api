...
var mongoserver = new mongodb.Server('localhost', 27017, {***REMOVED***);                   
var db_conn = new mongodb.Db('test1', mongoserver, { w : 1 ***REMOVED***);                  
...
// // new Db("node-mongo-examples", new Server("localhost", 27017), {w:1***REMOVED***).open(function(err, db) {
// var replSet = new ReplSet([new Server("localhost", 31000)
//   , new Server("localhost", 31001)
//   , new Server("localhost", 31002)])
// new Db("node-mongo-examples", replSet, {safe:true***REMOVED***).open(function(err, db) {
//   if(err) throw err;
//   console.log("=========================== 0")
//   db.close();
// ***REMOVED***);
...
// // // var options = {db: {safe: true***REMOVED***, server: {auto_reconnect: true***REMOVED******REMOVED***;
...
// // //     var lastErr = null;
// // //     setInterval(function () {
// // //       c.find({***REMOVED***).limit(100).toArray(function (err, results) {
// // //         if (err) {
// // //           lastErr = err;
// // //           errCount++;
// // //         ***REMOVED*** else {
