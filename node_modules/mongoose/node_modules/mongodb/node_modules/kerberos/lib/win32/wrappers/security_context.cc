...
static void After(uv_work_t* work_req) {
  ...
  if(worker->error) {
    ...
    v8::Local<v8::Value> args[2] = { err, v8::Local<v8::Value>::New(v8::Null()) ***REMOVED***;
    // Execute the error
  ...
  ***REMOVED*** else {
    ...
    v8::Handle<v8::Value> args[2] = { v8::Local<v8::Value>::New(v8::Null()), result***REMOVED***;
...
***REMOVED*** SecurityContextStaticInitializeCall;
...
typedef struct SecurityContextStepStaticInitializeCall {
  ...
  int decoded_input_str_length;
  SecurityContext *context;
***REMOVED*** SecurityContextStepStaticInitializeCall;
...
typedef struct SecurityContextEncryptMessageCall {
  ...
  unsigned long flags;
***REMOVED*** SecurityContextEncryptMessageCall;
...
typedef struct SecurityContextDecryptMessageCall {
  SecurityContext *context;
  SecurityBufferDescriptor *descriptor;
***REMOVED*** SecurityContextDecryptMessageCall;
...
typedef struct SecurityContextQueryContextAttributesCall {
  SecurityContext *context;
  uint32_t attribute;
***REMOVED*** SecurityContextQueryContextAttributesCall;
