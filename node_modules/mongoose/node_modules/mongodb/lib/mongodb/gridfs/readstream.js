 ...
 * @param {Boolean***REMOVED*** autoclose automatically close file when the stream reaches the end.
 * @param {GridStore***REMOVED*** cursor a cursor object that the stream wraps.
 * @return {ReadStream***REMOVED***
 */
