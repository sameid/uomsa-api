...
exports.parse = function(url, options) {
  ...
  ***REMOVED***
  ...
  var urlOptions;
  var servers;
  var serverOptions = {socketOptions: {***REMOVED******REMOVED***;
  var dbOptions = {read_preference_tags: []***REMOVED***;
  var replSetServersOptions = {socketOptions: {***REMOVED******REMOVED***;
  // Add server options to final object
  object.server_options = serverOptions;
  object.db_options = dbOptions;
  object.rs_options = replSetServersOptions;
  object.mongos_options = {***REMOVED***;
