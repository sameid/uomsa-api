...
var ConnectionPool = exports.ConnectionPool = function(host, port, poolSize, bson, socketOptions) {
  ...
  ***REMOVED***
  ...
  this.socketOptions = typeof socketOptions === 'object' ? socketOptions : {***REMOVED***;
  ...
  ***REMOVED*** else if(typeof port === 'string') {
    try { 
      port = parseInt(port, 10); 
    ***REMOVED*** catch(err) { 
      new Error("port must be specified or valid integer["  + port + "]"); 
    ***REMOVED***
  ***REMOVED*** else if(typeof port !== 'number') {
...
var _connect = function(_self) {
  // return new function() {
    ...
    connection.on("connect", function(err, connection) {
      ...
      ***REMOVED*** else if(_self.openConnections.length < _self.poolSize) {
