    ...
    ***REMOVED***
    ...
    if(err) {
      ...
      ***REMOVED***
      ...
      setTimeout(function() {
        self.start();
      ***REMOVED***, self.options.haInterval);
    ***REMOVED*** else {
      self.server = _server;
      // Let's boot the ha timeout settings
        ...
        , function(err, res) {
          ...
          ***REMOVED***
          ...
          for(var i = 0; i < hosts.length; i++) {
            ...
            ***REMOVED*** else if(state.addresses[host] && !state.addresses[host].isConnected()) {
            ...
            ***REMOVED***
            ...
            if((master.primary && state.master == null)
              ...
              ***REMOVED*** else if(state.master != null) {
          ...
          ***REMOVED***
      ***REMOVED***);
    ***REMOVED*** else if(!self.server.isConnected()) {
      setTimeout(function() {
        return self.start();
      ***REMOVED***, self.options.haInterval);
    ***REMOVED*** else {
