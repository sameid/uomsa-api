...
// return time for the db command {ping:true***REMOVED***
      ...
      new function(serverInstance) {
        ...
        if(_db != null) {
          ...
          var _ping = function(__db, __serverInstance) {
            ...
            __db.executeDbCommand({ping:1***REMOVED***, {failFast:true***REMOVED***, function(err) {
              if(err) {
              ...
              ***REMOVED***
              ...
              __db.executeDbCommand({ismaster:1***REMOVED***, {failFast:true***REMOVED***, function(err, result) {
                if(err) {
                  delete self.dbs[__db.serverConfig.host + ":" + __db.serverConfig.port];
                  __db.close();
                  return done();
        ...
        ***REMOVED*** else {
          ...
          var _server = new Server(serverInstance.host, serverInstance.port, {
            ...
            slaveOk: true,
            poolSize: 1,
            socketOptions: { connectTimeoutMS: connectTimeoutMS ***REMOVED***,
