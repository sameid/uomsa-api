...
var Options = function(options) {
  ...
  this.socketOptions = options.socketOptions || {***REMOVED***;
...
Options.prototype.init = function() {
  ...
  ***REMOVED*** 
  ...
  this.logger = this.logger != null
    ...
    && (typeof this.logger.debug == 'function')
      ? this.logger : {error:function(message, object) {***REMOVED***, log:function(message, object) {***REMOVED***, debug:function(message, object) {***REMOVED******REMOVED***;  
