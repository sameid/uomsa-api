...
var Connection = exports.Connection = function(id, socketOptions) {
  ...
  this.socketOptions = socketOptions ? socketOptions : {host:'localhost', port:27017, domainSocket:false***REMOVED***;
  ...
  this.eventHandlers = {error:[], parseError:[], poolReady:[], message:[], close:[], timeout:[], end:[]***REMOVED***;
...
Connection.prototype.close = function() {
  ...
  this.connection.on("error", function() {***REMOVED***)
  // destroy connection
...
var resetHandlers = function(self, clearListeners) {
  self.eventHandlers = {error:[], connect:[], close:[], end:[], timeout:[], parseError:[], message:[]***REMOVED***;
        ...
        ***REMOVED*** else {
          ...
          ***REMOVED*** catch(err) {
            var errorObject = {err:"socketHandler", trace:err, bin:self.buffer, parseState:{
              ...
              stubBuffer:self.stubBuffer***REMOVED******REMOVED***;
      ...
      ***REMOVED*** else {
        ...
        ***REMOVED*** else {
          if(data.length > 4) {
            ...
            ***REMOVED*** else if(sizeOfMessage > 4 && sizeOfMessage < self.maxBsonSize && sizeOfMessage == data.length) {
              try {
                var emitBuffer = data;
                // Reset state of buffer
                self.buffer = null;
              ...
              ***REMOVED*** catch (err) {
                ...
                self.emit("parseError", errorObject, self);
              ***REMOVED***
            ***REMOVED*** else if(sizeOfMessage <= 4 || sizeOfMessage > self.maxBsonSize) {
              var errorObject = {err:"socketHandler", trace:null, bin:data, parseState:{
                sizeOfMessage:sizeOfMessage,
                bytesRead:0,
                buffer:null,
                stubBuffer:null***REMOVED******REMOVED***;
              if(self.logger != null && self.logger.doError) self.logger.error("parseError", errorObject);
              // We got a parse Error fire it off then keep going
              self.emit("parseError", errorObject, self);
...
var endHandler = function(self) {
  return function() {
    ...
    // Emit end event
    self.emit("end", {err: 'connection received Fin packet from [' + self.socketOptions.host + ':' + self.socketOptions.port + ']'***REMOVED***, self);
  ***REMOVED***
***REMOVED***
...
var timeoutHandler = function(self) {
  return function() {
    ...
    self.connected = false;
    // Emit timeout event
    self.emit("timeout", {err: 'connection to [' + self.socketOptions.host + ':' + self.socketOptions.port + '] timed out'***REMOVED***, self);
  ***REMOVED***
***REMOVED***
...
var errorHandler = function(self) {
  return function(err) {
    ...
    self.connected = false;
    // Emit error
    self.emit("error", {err: 'failed to connect to [' + self.socketOptions.host + ':' + self.socketOptions.port + ']'***REMOVED***, self);
  ***REMOVED***
***REMOVED***
...
var closeHandler = function(self) {
  return function(hadError) {
    ...
    ***REMOVED*** else {
      ...
      self.connected = false;
      // Emit close
      self.emit("close", {err: 'connection closed to [' + self.socketOptions.host + ':' + self.socketOptions.port + ']'***REMOVED***, self);
    ***REMOVED***
  ***REMOVED***
***REMOVED***
