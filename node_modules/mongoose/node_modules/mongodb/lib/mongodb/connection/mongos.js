 ...
 *  - **ha** {Boolean, default:true***REMOVED***, turn on high availability, attempts to reconnect to down proxies
 ...
 * @param {Array***REMOVED*** list of mongos server objects
 * @param {Object***REMOVED*** [options] additional options for the mongos connection
 */
var Mongos = function Mongos(servers, options) {
  ...
  this.socketOptions = this.options.socketOptions != null ? this.options.socketOptions : {***REMOVED***;
  // Enabled ha
  ...
  this.downServers = {***REMOVED***;
  // Servers that are up
  this.upServers = {***REMOVED***;
  // Up servers by ping time
  this.upServersByUpTime = {***REMOVED***;
  // Emit open setup
  ...
  for(var i = 0; i < this.servers.length; i++) {
    ...
    var socketOptions = {host: server.host, port: server.port***REMOVED***;
          ...
          return function() {
            ...
            _server.connect(_db, _options, function(err, result) {
              ...
              ***REMOVED*** else {                
                ...
                self.db.command({ping:1***REMOVED***
                  , {failFast:true, connection:_connection***REMOVED***, function(err, result) {
                  // Get the start time
  ...
  ***REMOVED***
  ...
  for(var i = 0; i < this.servers.length; i++) {
    ...
    var options = {
      ...
      socketOptions: { connectTimeoutMS: self._connectTimeoutMS ***REMOVED***,
      returnIsMasterResults: true
    ***REMOVED***        
...
Mongos.prototype.checkoutReader = function(read) {
  ...
  ***REMOVED*** else if(!ReadPreference.isValid(read)) {
