 ...
 *
 * @param {Object***REMOVED*** doc values with which to create the document
 * @inherits Document
 ...
 *
 * @param {Function***REMOVED*** [fn] optional callback
 * @api public
...
Model.prototype.save = function save (fn) {
  ...
  ***REMOVED***
  ...
  if (this.isNew) {
    // send entire doc
    var obj = this.toObject({ depopulate: 1 ***REMOVED***);
 ...
 *
 * @param {Document***REMOVED*** self
 * @param {Object***REMOVED*** where
 * @param {Object***REMOVED*** delta
 * @param {Object***REMOVED*** data
 * @param {Mixed***REMOVED*** val
 * @param {String***REMOVED*** [operation]
 */

function operand (self, where, delta, data, val, op) {
  // delta
  op || (op = '$set');
  if (!delta[op]) delta[op] = {***REMOVED***;
  ...
  ***REMOVED***
  ...
  if (0 === i) {
    ...
    if (isMongooseObject(value)) {
      value = value.toObject({ depopulate: 1 ***REMOVED***);
...
Model.prototype.$__delta = function () {
  ...
  for (; d < len; ++d) {
    ...
    ***REMOVED*** else if (null === value) {
      operand(this, where, delta, data, null);

    ***REMOVED*** else if (value._path && value._atomics) {
      // arrays and other custom types (support plugins etc)
      handleAtomics(this, where, delta, data, value);

    ***REMOVED*** else if (value._path && Buffer.isBuffer(value)) {
      // MongooseBuffer
      value = value.toObject();
      operand(this, where, delta, data, value);

    ***REMOVED*** else {
      value = utils.clone(value, { depopulate: 1 ***REMOVED***);
      operand(this, where, delta, data, value);
    ***REMOVED***
  ***REMOVED***
 ...
 *
 * @param {String***REMOVED*** name model name
 * @api public
 */
 ...
 * ####Example:
 *
 *     var eventSchema = new Schema({ thing: { type: 'string', unique: true ***REMOVED******REMOVED***)
 ...
 *
 * @param {Function***REMOVED*** [cb] optional callback
 * @api public
 */
 ...
 * ####Example:
 *
 *     Comment.remove({ title: 'baby born from alien father' ***REMOVED***, function (err) {
 *
 *     ***REMOVED***);
 *
 * ####Note:
 ...
 *
 *     var query = Comment.remove({ _id: id ***REMOVED***);
 *     query.exec();
 *
 * ####Note:
 *
 ...
 *     MyModel.find({ name: 'john', age: { $gte: 18 ***REMOVED******REMOVED***);
 *
 *     // executes immediately, passing results to callback
 *     MyModel.find({ name: 'john', age: { $gte: 18 ***REMOVED******REMOVED***, function (err, docs) {***REMOVED***);
 *
 *     // name LIKE john and only selecting the "name" and "friends" fields, executing immediately
 *     MyModel.find({ name: /john/i ***REMOVED***, 'name friends', function (err, docs) { ***REMOVED***)
 *
 *     // passing options
 *     MyModel.find({ name: /john/i ***REMOVED***, null, { skip: 10 ***REMOVED***)
 *
 *     // passing options and executing immediately
 *     MyModel.find({ name: /john/i ***REMOVED***, null, { skip: 10 ***REMOVED***, function (err, docs) {***REMOVED***);
 *
 *     // executing a query explicitly
 *     var query = MyModel.find({ name: /john/i ***REMOVED***, null, { skip: 10 ***REMOVED***)
 *     query.exec(function (err, docs) {***REMOVED***);
 *
 *     // using the promise returned from executing a query
 *     var query = MyModel.find({ name: /john/i ***REMOVED***, null, { skip: 10 ***REMOVED***);
 *     var promise = query.exec();
 *     promise.addBack(function (err, docs) {***REMOVED***);
 *
 * @param {Object***REMOVED*** conditions
 * @param {Object***REMOVED*** [fields] optional fields to select
...
Model.find = function find (conditions, fields, options, callback) {
  if ('function' == typeof conditions) {
    ...
    fields = null;
    options = null;
  ***REMOVED*** else if ('function' == typeof fields) {
    callback = fields;
    fields = null;
    options = null;
  ***REMOVED*** else if ('function' == typeof options) {
    callback = options;
    options = null;
  ***REMOVED***
 ...
 *     Adventure.findById(id, 'name length', function (err, adventure) {***REMOVED***);
 *
 *     // same as above
 *     Adventure.findById(id, 'name length').exec(callback);
 *
 *     // include all properties except for `length`
 *     Adventure.findById(id, '-length').exec(function (err, adventure) {***REMOVED***);
 *
 *     // passing options (in this case return the raw js objects, not mongoose documents by passing `lean`
 *     Adventure.findById(id, 'name', { lean: true ***REMOVED***, function (err, doc) {***REMOVED***);
 *
 *     // same as above
 *     Adventure.findById(id, 'name').lean().exec(function (err, doc) {***REMOVED***);
 *
 * @param {ObjectId|HexId***REMOVED*** id objectid, or a value that can be casted to one
 * @param {Object***REMOVED*** [fields] optional fields to select
 * @param {Object***REMOVED*** [options] optional
 * @param {Function***REMOVED*** [callback]
 * @return {Query***REMOVED***
...
Model.findById = function findById (id, fields, options, callback) {
  return this.findOne({ _id: id ***REMOVED***, fields, options, callback);
***REMOVED***;
 ...
 *     Adventure.findOne({ type: 'iphone' ***REMOVED***, function (err, adventure) {***REMOVED***);
 *
 *     // same as above
 *     Adventure.findOne({ type: 'iphone' ***REMOVED***).exec(function (err, adventure) {***REMOVED***);
 *
 *     // select only the adventures name
 *     Adventure.findOne({ type: 'iphone' ***REMOVED***, 'name', function (err, adventure) {***REMOVED***);
 *
 *     // same as above
 *     Adventure.findOne({ type: 'iphone' ***REMOVED***, 'name').exec(function (err, adventure) {***REMOVED***);
 *
 *     // specify options, in this case lean
 *     Adventure.findOne({ type: 'iphone' ***REMOVED***, 'name', { lean: true ***REMOVED***, callback);
 *
 *     // same as above
 *     Adventure.findOne({ type: 'iphone' ***REMOVED***, 'name', { lean: true ***REMOVED***).exec(callback);
 *
 *     // chaining findOne queries (same as above)
 *     Adventure.findOne({ type: 'iphone' ***REMOVED***).select('name').lean().exec(callback);
 *
 * @param {Object***REMOVED*** conditions
 * @param {Object***REMOVED*** [fields] optional fields to select
 * @param {Object***REMOVED*** [options] optional
 ...
 * ####Example:
 *
 *     Adventure.count({ type: 'jungle' ***REMOVED***, function (err, count) {
 *       if (err) ..
...
Model.count = function count (conditions, callback) {
  if ('function' === typeof conditions)
    callback = conditions, conditions = {***REMOVED***;
 ...
 * ####Example
 *
 *     Link.distinct('url', { clicks: {$gt: 100***REMOVED******REMOVED***, function (err, result) {
 *       if (err) return handleError(err);
 *
 ...
 * @param {Object***REMOVED*** [conditions] optional
 * @param {Function***REMOVED*** [callback]
 * @return {Query***REMOVED***
 * @api public
 */
 ...
 *
 * @param {String***REMOVED*** path
 * @param {Object***REMOVED*** [val] optional value
 * @return {Query***REMOVED***
 * @api public
 */
 ...
 *
 * Sometimes you need to query for things in mongodb using a JavaScript expression. You can do so via `find({ $where: javascript ***REMOVED***)`, or you can use the mongoose shortcut method $where via a Query chain or from your mongoose Model.
 *
 *     Blog.$where('this.comments.length > 5').exec(function (err, docs) {***REMOVED***);
 *
 * @param {String|Function***REMOVED*** argument is a javascript string or anonymous function
 * @method $where
 * @memberOf Model
 * @return {Query***REMOVED***
 ...
 * ####Example:
 *
 *     var query = { name: 'borne' ***REMOVED***;
 *     Model.findOneAndUpdate(query, { name: 'jason borne' ***REMOVED***, options, callback)
 *
 *     // is sent as
 *     Model.findOneAndUpdate(query, { $set: { name: 'jason borne' ***REMOVED******REMOVED***, options, callback)
 *
 * This helps prevent accidentally overwriting your document with `{ name: 'jason borne' ***REMOVED***`.
 *
 * ####Note:
 *
 ...
 *
 *     Model.findOne({ name: 'borne' ***REMOVED***, function (err, doc) {
 *       if (err) ..
 ...
 * ####Example:
 *
 *     Model.findByIdAndUpdate(id, { name: 'jason borne' ***REMOVED***, options, callback)
 *
 *     // is sent as
 *     Model.findByIdAndUpdate(id, { $set: { name: 'jason borne' ***REMOVED******REMOVED***, options, callback)
 *
 * This helps prevent accidentally overwriting your document with `{ name: 'jason borne' ***REMOVED***`.
 *
 * ####Note:
 ...
 *     ***REMOVED***)
 *
 * @param {ObjectId|HexId***REMOVED*** id an ObjectId or string that can be cast to one.
 * @param {Object***REMOVED*** [update]
 * @param {Object***REMOVED*** [options]
 * @param {Function***REMOVED*** [callback]
 * @return {Query***REMOVED***
...
Model.findByIdAndUpdate = function (id, update, options, callback) {
  ...
  if (1 === arguments.length) {
    if ('function' == typeof id) {
      ...
      throw new TypeError(msg)
    ***REMOVED***
    return this.findOneAndUpdate({_id: id ***REMOVED***, undefined);
  ***REMOVED***

  args = utils.args(arguments, 1);
  args.unshift({ _id: id ***REMOVED***);
 ...
 *
 * @param {ObjectId|HexString***REMOVED*** id ObjectId or string that can be cast to one
 * @param {Object***REMOVED*** [options]
 * @param {Function***REMOVED*** [callback]
 * @return {Query***REMOVED***
...
Model.findByIdAndRemove = function (id, options, callback) {
  ...
  ***REMOVED***
  ...
  return this.findOneAndRemove({ _id: id ***REMOVED***, options, callback);
***REMOVED***
 ...
 * ####Example:
 *
 *     Candy.create({ type: 'jelly bean' ***REMOVED***, { type: 'snickers' ***REMOVED***, function (err, jellybean, snickers) {
 *       if (err) // ...
 *     ***REMOVED***);
 *
 *     var array = [{ type: 'jelly bean' ***REMOVED***, { type: 'snickers' ***REMOVED***];
 *     Candy.create(array, function (err, jellybean, snickers) {
 *       if (err) // ...
 *     ***REMOVED***);
 *
 * @param {Array|Object...***REMOVED*** doc
 * @param {Function***REMOVED*** fn callback
 * @api public
 */
 ...
 * ####Examples:
 *
 *     MyModel.update({ age: { $gt: 18 ***REMOVED*** ***REMOVED***, { oldEnough: true ***REMOVED***, fn);
 *     MyModel.update({ name: 'Tobi' ***REMOVED***, { ferret: true ***REMOVED***, { multi: true ***REMOVED***, function (err, numberAffected, raw) {
 *       if (err) return handleError(err);
 ...
 *
 *     var query = { name: 'borne' ***REMOVED***;
 *     Model.update(query, { name: 'jason borne' ***REMOVED***, options, callback)
 *
 *     // is sent as
 *     Model.update(query, { $set: { name: 'jason borne' ***REMOVED******REMOVED***, options, callback)
 *
 * This helps prevent accidentally overwriting all documents in your collection with `{ name: 'jason borne' ***REMOVED***`.
 *
 * ####Note:
 *
 ...
 *
 *     Comment.update({ _id: id ***REMOVED***, { $set: { text: 'changed' ***REMOVED******REMOVED***).exec();
 *
 * ####Note:
 *
...
Model.update = function update (conditions, doc, options, callback) {
  if (arguments.length < 4) {
    if ('function' === typeof options) {
      ...
      callback = options;
      options = null;
    ***REMOVED*** else if ('function' === typeof doc) {
 ...
 *
 *     var o = {***REMOVED***;
 *     o.map = function () { emit(this.name, 1) ***REMOVED***
 *     o.reduce = function (k, vals) { return vals.length ***REMOVED***
 ...
 * ####Other options:
 *
 * - `query` {Object***REMOVED*** query filter object.
 * - `limit` {Number***REMOVED*** max number of documents
 * - `keeptemp` {Boolean, default:false***REMOVED*** keep temporary data
 * - `finalize` {Function***REMOVED*** finalize function
 * - `scope` {Object***REMOVED*** scope variables exposed to map/reduce/finalize during execution
 * - `jsMode` {Boolean, default:false***REMOVED*** it is possible to make the execution stay in JS. Provided in MongoDB > 2.0.X
 * - `verbose` {Boolean, default:false***REMOVED*** provide statistics on job execution time.
 * - `out*` {Object, default: {inline:1***REMOVED******REMOVED*** sets the output target for the map reduce job.
 *
 * ####* out options:
 *
 * - `{inline:1***REMOVED***` the results are returned in an array
 * - `{replace: 'collectionName'***REMOVED***` add the results to collectionName: the results replace the collection
 * - `{reduce: 'collectionName'***REMOVED***` add the results to collectionName: if dups are detected, uses the reducer / finalize functions
 * - `{merge: 'collectionName'***REMOVED***` add the results to collectionName: if dups exist the new docs overwrite the old
 *
 ...
 *     o.map = function () { emit(this.name, 1) ***REMOVED***
 *     o.reduce = function (k, vals) { return vals.length ***REMOVED***
 *     o.out = { replace: 'createdCollectionNameForResults' ***REMOVED***
 *     o.verbose = true;
 ...
 *     ***REMOVED***)
 *
 * @param {Object***REMOVED*** o an object specifying map-reduce options
 * @param {Function***REMOVED*** callback
...
Model.mapReduce = function mapReduce (o, callback) {
  ...
  if (!Model.mapReduce.schema) {
    var opts = { noId: true, noVirtualId: true, strict: false ***REMOVED***
    Model.mapReduce.schema = new Schema({***REMOVED***, opts);
  ***REMOVED***

  if (!o.out) o.out = { inline: 1 ***REMOVED***;
 ...
 *     Users.aggregate(
 *         { $group: { _id: null, maxAge: { $max: '$age' ***REMOVED******REMOVED******REMOVED***
 *       , { $project: { _id: 0, maxAge: 1 ***REMOVED******REMOVED***
 *       , function (err, res) {
 *       if (err) return handleError(err);
 *       console.log(res); // [ { maxAge: 98 ***REMOVED*** ]
 *     ***REMOVED***);
 *
 * ####NOTE:
 *
 ...
 *
 * @param {Array***REMOVED*** array an array of pipeline commands
 * @param {Object***REMOVED*** [options]
 * @param {Function***REMOVED*** callback
 ...
 *       var opts = [
 *           { path: 'company', match: { x: 1 ***REMOVED***, select: 'name' ***REMOVED***
 *         , { path: 'notes', options: { limit: 10 ***REMOVED***, model: 'override' ***REMOVED***
 *       ]
 *
 ...
 *       var opts = [{ path: 'company', match: { x: 1 ***REMOVED***, select: 'name' ***REMOVED***]
 *
 ...
 *
 *     var user = { name: 'Indiana Jones', weapon: 389 ***REMOVED***
 *     Weapon.populate(user, { path: 'weapon', model: 'Weapon' ***REMOVED***, function (err, user) {
 *       console.log(user.weapon.name) // whip
 *     ***REMOVED***)
 *
 *     // populate many plain objects
 *     var users = [{ name: 'Indiana Jones', weapon: 389 ***REMOVED***]
 *     users.push({ name: 'Batman', weapon: 8921 ***REMOVED***)
 *     Weapon.populate(users, { path: 'weapon' ***REMOVED***, function (err, users) {
 ...
 *
 * @param {Document|Array***REMOVED*** docs Either a single document or array of documents to populate.
 * @param {Object***REMOVED*** options A hash of key/val (path, options) used for population.
 * @param {Function***REMOVED*** cb(err,doc) A callback, executed upon completion. Receives `err` and the `doc(s)`.
 * @api public
 */
...
function populateDocs (docs, options, cb) {
  ...
  ***REMOVED***
  ...
  match._id || (match._id = { $in: ids ***REMOVED***);

  var assignmentOpts = {***REMOVED***;
 ...
 *
 * @param {Array|Document|Any***REMOVED*** val
 * @return {Array|Document|Any***REMOVED***
 */
 ...
 * @param {String***REMOVED*** collectionName
 * @param {Connection***REMOVED*** connection
 * @param {Mongoose***REMOVED*** base mongoose instance
 */
 ...
 *
 * @param {Connection***REMOVED*** conn
 * @param {Schema***REMOVED*** [schema]
 * @param {String***REMOVED*** [collection]
