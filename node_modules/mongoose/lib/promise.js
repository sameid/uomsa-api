 ...
 *
 *     var query = Candy.find({ bar: true ***REMOVED***);
 *     var promise = query.exec();
 *
 * @param {Function***REMOVED*** fn a function which will be called when the promise is resolved that accepts `fn(err, ...){***REMOVED***` as signature
 ...
 * @method reject
 * @memberOf Promise
 * @param {Object|String|Error***REMOVED*** reason
 * @return {Promise***REMOVED*** this
 * @api public
 */
 ...
 *
 * @api public
 * @param {Error|String***REMOVED*** err
 * @return {Promise***REMOVED*** this
 */
 ...
 *
 * @param {Error***REMOVED*** [err] error or null
 * @param {Object***REMOVED*** [val] value to fulfill the promise with
 * @api public
 */
 ...
 * ####Example:
 *
 *     var promise = Meetups.find({ tags: 'javascript' ***REMOVED***).select('_id').exec();
 *     promise.then(function (meetups) {
 *       var ids = meetups.map(function (m) {
 *         return m._id;
 *       ***REMOVED***);
 *       return People.find({ meetups: { $in: ids ***REMOVED***).exec();
 *     ***REMOVED***).then(function (people) {
 ...
 * @method then
 * @memberOf Promise
 * @param {Function***REMOVED*** onFulFill
 * @param {Function***REMOVED*** onReject
 * @return {Promise***REMOVED*** newPromise
 */
