 ...
 * @param {String|Array***REMOVED*** pref
 * @param {Array***REMOVED*** [tags]
 */
  ...
  if (1 === arguments.length) {
    ...
    ***REMOVED***
    ...
    if (exports.isObject(path)) {
      ...
      path = path.path;
    ***REMOVED***
  ***REMOVED*** else if ('string' !== typeof model) {
    options = match;
    match = model;
    model = undefined;
  ***REMOVED***
