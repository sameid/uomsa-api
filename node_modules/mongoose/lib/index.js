 ...
 * @param {Object***REMOVED*** [options] options to pass to the driver
 * @see Connection#open #connection_Connection-open
 * @see Connection#openSet #connection_Connection-openSet
 * @return {Connection***REMOVED*** the created Connection object
 * @api public
 */
 ...
 *
 * @param {Function***REMOVED*** [fn] called after all connection close.
 * @return {Mongoose***REMOVED*** this
 * @api public
 */
 ...
 * @param {String***REMOVED*** [collection] name (optional, induced from model name)
