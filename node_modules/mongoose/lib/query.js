...
function Query (criteria, options) {
  ...
  this._conditions = {***REMOVED***;
  this._updateArg = {***REMOVED***;
...
Query.prototype.setOptions = function (options, overwrite) {
  ...
  if (overwrite) {
    options = this.options = options || {***REMOVED***;
 ...
 *
 * @param {Model***REMOVED*** model the model to which the query is bound
 * @param {String***REMOVED*** op the operation to execute
 * @param {Object***REMOVED*** updateArg used in update methods
...
Query.prototype.bind = function bind (model, op, updateArg) {
  ...
  if (op == 'update' || op == 'findOneAndUpdate') {
    merge(this._updateArg, updateArg || {***REMOVED***);
  ***REMOVED***
 ...
 * ####Example
 *
 *     query.find({ name: 'Los Pollos Hermanos' ***REMOVED***).find(callback)
 *
...
Query.prototype.find = function (criteria, callback) {
  ...
  if ('function' === typeof criteria) {
    callback = criteria;
    criteria = {***REMOVED***;
  ***REMOVED*** else if (criteria instanceof Query) {
    // TODO Merge options, too
    merge(this._conditions, criteria._conditions);
  ***REMOVED*** else if (criteria instanceof Document) {
    merge(this._conditions, criteria.toObject());
  ***REMOVED*** else if (criteria && 'Object' === criteria.constructor.name) {
...
Query.prototype.cast = function (model, obj) {
  ...
  while (i--) {
    ...
    ***REMOVED*** else {
      ...
      if (!schematype) {
        ...
        ***REMOVED***
        ...
        if (utils.isObject(val)) {
          ...
          // { loc: { long: Number, lat: Number ***REMOVED***
          ...
          ***REMOVED*** else if ('$near' == geo &&
              'string' == typeof value.type && Array.isArray(value.coordinates)) {
            // geojson; cast the coordinates
            value = value.coordinates;

          ***REMOVED*** else if (('$near' == geo || '$geoIntersects' == geo) &&
      ...
      ***REMOVED*** else if (val === null || val === undefined) {
        continue;
      ***REMOVED*** else if ('Object' === val.constructor.name) {
...
Query.prototype._optionsForExec = function (model) {
  var options = utils.clone(this.options, { retainKeyOrder: true ***REMOVED***);
...
Query.prototype.near = function (path, val) {
  if (arguments.length === 1) {
    val = path;
    path = this._currPath
  ***REMOVED*** else if (arguments.length === 2 && !Array.isArray(val)) {
...
Query.prototype.elemMatch = function (path, criteria) {
  ...
  if ('Object' === path.constructor.name) {
    criteria = path;
    path = this._currPath;
  ***REMOVED*** else if ('function' === typeof path) {
    block = path;
    path = this._currPath;
  ***REMOVED*** else if ('Object' === criteria.constructor.name) {
  ***REMOVED*** else if ('function' === typeof criteria) {
    block = criteria;
  ***REMOVED*** else {
 ...
 *     query.where('loc').within.box({ ll: lowerLeft , ur: upperRight ***REMOVED***)
 *
 * @see http://www.mongodb.org/display/DOCS/Geospatial+Indexing
...
Query.prototype.box = function (path, val) {
  ...
  ***REMOVED***
  var conds = this._conditions[path] || (this._conditions[path] = {***REMOVED***);
  conds['$within'] = { '$box': [val.ll, val.ur]  ***REMOVED***;
  return this;
***REMOVED***;
 ...
 * ####Example
 *
 *     var area = { center: [50, 50], radius: 10 ***REMOVED***
 *     query.where('loc').within.center(area)
 *
 * @param {String***REMOVED*** path
 * @param {Object***REMOVED*** val
 * @param {Object***REMOVED*** [opts] options e.g. { $uniqueDocs: true ***REMOVED***
 * @return {Query***REMOVED*** this
 * @see http://www.mongodb.org/display/DOCS/Geospatial+Indexing
...
Query.prototype.center = function (path, val, opts) {
  ...
  ***REMOVED***
  var conds = this._conditions[path] || (this._conditions[path] = {***REMOVED***);
  conds['$within'] = { '$center': [val.center, val.radius]  ***REMOVED***;
...
Query.prototype.centerSphere = function (path, val) {
  ...
  ***REMOVED***
  var conds = this._conditions[path] || (this._conditions[path] = {***REMOVED***);
  conds['$within'] = { '$centerSphere': [val.center, val.radius]  ***REMOVED***;
  return this;
***REMOVED***;
 ...
 *
 *     // or
 *     var polyB = { a : { x : 10, y : 20 ***REMOVED***, b : { x : 15, y : 25 ***REMOVED***, c : { x : 20, y : 20 ***REMOVED*** ***REMOVED***
...
Query.prototype.polygon = function (path, val) {
  ...
  ***REMOVED***
  var conds = this._conditions[path] || (this._conditions[path] = {***REMOVED***);
  conds['$within'] = { '$polygon': val ***REMOVED***;
  return this;
***REMOVED***;
 ...
 * When called with one argument, the most recent path passed to `where()` is used.
 *
 * @param {String***REMOVED*** [path] Optional name of a path to match against
 * @param {Object***REMOVED*** object Must contain a `type` property which is a String and a `coordinates` property which is an Array. See the example.
 * @return {Query***REMOVED*** this
...
Query.prototype.select = function select (arg) {
  ...
  if ('Object' === arg.constructor.name) {
    ...
    ***REMOVED***);
  ***REMOVED*** else if (1 === arguments.length && 'string' == typeof arg) {
 ...
 *
 * @param {String***REMOVED*** path
 * @param {Number***REMOVED*** val number of elements to slice
 * @return {Query***REMOVED*** this
...
function push (arr, field, value) {
  ...
  if (!/^(?:ascending|asc|descending|desc|1|-1)$/.test(val)) {
    ...
    throw new TypeError('Invalid sort value: {' + field + ': ' + value + ' ***REMOVED***');
  ***REMOVED***
 ...
 * ####Example
 *
 *     Model.find().hint({ indexA: 1, indexB: -1***REMOVED***)
 *
 * @param {Object***REMOVED*** val a hint object
 * @return {Query***REMOVED*** this
 ...
 *     new Query().read('secondary', [{ dc:'sf', s: 1 ***REMOVED***,{ dc:'ma', s: 2 ***REMOVED***])
 *
 * Read more about how to use read preferrences [here](http://docs.mongodb.org/manual/applications/replication/#read-preference) and [here](http://mongodb.github.com/node-mongodb-native/driver-articles/anintroductionto1_1and2_2.html#read-preferences).
 *
 * @param {String***REMOVED*** pref one of the listed preference options or aliases
 * @param {Array***REMOVED*** [tags] optional tags for this query
 * @see mongodb http://docs.mongodb.org/manual/applications/replication/#read-preference
 ...
 *
 * @param {Boolean***REMOVED*** bool defaults to true
 * @return {Query***REMOVED*** this
 * @api public
 */
 ...
 * @param {Object***REMOVED*** fields
 * @param {Query***REMOVED*** self
 * @param {Array***REMOVED*** [pop] array of paths used in population
 * @param {Promise***REMOVED*** promise
 */
 ...
 * ####Example
 *
 *     var query = Kitten.find({ color: 'white'***REMOVED***);
 *
 ...
 * ####Example
 *
 *     Link.find({ clicks: { $gt: 100 ***REMOVED******REMOVED***).distinct('url', function (err, result) {
 *       if (err) return handleError(err);
 *
 ...
 * ####Example
 *
 *     Model.update({..***REMOVED***, { title: 'remove words' ***REMOVED***, ...)
 *
 *     // becomes
 *
 *     Model.update({..***REMOVED***, { $set: { title: 'remove words' ***REMOVED******REMOVED***, ...)
 *
 * ####Note
 *
 * Passing an empty object `{***REMOVED***` as the doc will result in a no-op. The update operation will be ignored and the callback executed without sending the command to MongoDB so as to prevent accidently overwritting the collection.
 *
 * @param {Object***REMOVED*** doc the update conditions
 * @param {Function***REMOVED*** callback
 * @return {Query***REMOVED*** this
 * @api public
 ...
 *
 * @param {Object***REMOVED*** obj
 * @return {Object***REMOVED*** obj after casting its values
 * @api private
 */
 ...
 *
 *     query.select({ ids: { $elemMatch: { $in: [hexString] ***REMOVED******REMOVED***)
 *
 * @param {Object***REMOVED*** fields
...
Query.prototype.findOneAndUpdate = function (query, doc, options, callback) {
  ...
  ***REMOVED***
  ...
  if (query) {
    ...
    ***REMOVED*** else if (query instanceof Query) {
      merge(this._conditions, query._conditions);
    ***REMOVED*** else if (query instanceof Document) {
...
Query.prototype.findOneAndRemove = function (conditions, options, callback) {
  ...
  ***REMOVED***
  ...
  if (conditions) {
    ...
    ***REMOVED*** else if (conditions instanceof Query) {
      merge(this._conditions, conditions._conditions);
    ***REMOVED*** else if (conditions instanceof Document) {
  ...
  ***REMOVED*** else {
    ...
    if (!castedDoc) {
      if (opts.upsert) {
        ...
        castedDoc = { $set: {***REMOVED*** ***REMOVED***;
      ***REMOVED*** else {
        return this.findOne(callback);
      ***REMOVED***
    ***REMOVED*** else if (castedDoc instanceof Error) {
 ...
 *         path: 'owner'
 *       , select: 'name'
 *       , match: { color: 'black' ***REMOVED***
 *       , options: { sort: { name: -1 ***REMOVED******REMOVED***
 *     ***REMOVED***).exec(function (err, kittens) {
 *       console.log(kittens[0].owner.name) // Zoopa
 *     ***REMOVED***)
 *
 *     // alternatively
 *     Kitten.find().populate('owner', 'name', null, {sort: { name: -1 ***REMOVED******REMOVED***).exec(function (err, kittens) {
 *       console.log(kittens[0].owner.name) // Zoopa
 *     ***REMOVED***)
 *
 * Paths are populated after the query executes and a response is received. A separate query is then executed for each path specified for population. After a response for each query has also been returned, the results are passed to the callback.
 *
 * @param {Object|String***REMOVED*** path either the path to populate or an object specifying all parameters
 * @param {Object|String***REMOVED*** [select] Field selection for the population query
 * @param {Model***REMOVED*** [model] The name of the model you wish to use for population. If not specified, the name is looked up from the Schema ref.
 * @param {Object***REMOVED*** [match] Conditions for the population query
 * @param {Object***REMOVED*** [options] Options for the population query (sort, etc)
 ...
 *     Thing.find({ name: /^hello/ ***REMOVED***).stream().pipe(res)
 *
 *     // manual streaming
 *     var stream = Thing.find({ name: /^hello/ ***REMOVED***).stream();
 *
 *     stream.on('data', function (doc) {
 *       // do something with the mongoose document
 *     ***REMOVED***).on('error', function (err) {
 *       // handle the error
 *     ***REMOVED***).on('close', function () {
 ...
 *     var stream = Thing.find().stream({ transform: JSON.stringify ***REMOVED***);
 *     stream.pipe(writeStream);
 *
 * @return {QueryStream***REMOVED***
 * @param {Object***REMOVED*** [options]
 * @see QueryStream
 * @api public
 */
