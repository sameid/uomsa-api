...
/*
    ...
    ***REMOVED***
    ...
    callback: function (err, credentials, artifacts) { ***REMOVED***
 */
...
exports.authenticate = function (req, credentialsFunc, options, callback) {
    ...
    options.nonceFunc = options.nonceFunc || function (nonce, ts, nonceCallback) { return nonceCallback(); ***REMOVED***;   // No validation
        ...
        options.nonceFunc(attributes.nonce, attributes.ts, function (err) {
            ...
            ***REMOVED***
            ...
            if (Math.abs((attributes.ts * 1000) - now) > (options.timestampSkewSec * 1000)) {
                ...
                return callback(Boom.unauthorized('Stale timestamp', 'Hawk', { ts: fresh, tsm: tsm ***REMOVED***), credentials, artifacts);
            ***REMOVED***
...
/*
    credentials: {***REMOVED***,                                        // Object received from authenticate()
    artifacts: {***REMOVED***                                           // Object received from authenticate(); 'mac', 'hash', and 'ext' - ignored
    options: {
