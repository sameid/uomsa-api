    ...
    ***REMOVED***);
    ...
    describe('#unauthorized', function () {
        ...
        it('returns a 401 error code', function (done) {
            ...
            expect(err.response.headers).to.deep.equal({***REMOVED***);
            done();
        ***REMOVED***);
    ...
    describe('#internal', function () {
        ...
        ***REMOVED***);
        ...
        it('passes data on the callback if its passed in', function (done) {
            ...
            expect(Boom.internal('my message', { my: 'data' ***REMOVED***).data.my).to.equal('data');
            done();
        ***REMOVED***);
    ...
    ***REMOVED***);
    ...
    describe('#passThrough', function () {
        ...
        it('returns a pass-through error', function (done) {
            ...
            var err = Boom.passThrough(499, { a: 1 ***REMOVED***, 'application/text', { 'X-Test': 'Boom' ***REMOVED***);
            expect(err.response.code).to.equal(499);
            expect(err.message).to.equal('Pass-through');
            expect(err.response).to.deep.equal({
                code: 499,
                payload: { a: 1 ***REMOVED***,
                headers: { 'X-Test': 'Boom' ***REMOVED***,
