...
describe('Hoek', function () {
    ...
    ***REMOVED***;
    ...
    var dupsArray = [nestedObj, { z: 'z' ***REMOVED***, nestedObj];
    var reducedDupsArray = [nestedObj, { z: 'z' ***REMOVED***];
    ...
    describe('#clone', function () {
        ...
        ***REMOVED***);
        ...
        it('should not convert undefined properties to null', function (done) {
            ...
            var obj = { something: undefined ***REMOVED***;
        ...
        ***REMOVED***);
        ...
        it('copies functions with properties', function (done) {
            ...
            var a = {
                x: function () { return 1; ***REMOVED***,
                y: {***REMOVED***
            ***REMOVED***;
            a.x.z = 'string in function';
            a.x.v = function () { return 2; ***REMOVED***;
            a.y.u = a.x;
    ...
    describe('#merge', function () {
        ...
        ***REMOVED***);
        ...
        it('should override values in target', function (done) {
            ...
            var a = { x: 1, y: 2, z: 3, v: 5, t: 'test', m: 'abc' ***REMOVED***;
            var b = { x: null, z: 4, v: 0, t: { u: 6 ***REMOVED***, m: '123' ***REMOVED***;
            ...
            expect(c.t).to.deep.equal({ u: 6 ***REMOVED***);
            done();
        ***REMOVED***);
        ...
        ***REMOVED***);
        ...
        it('should apply object to defaults', function (done) {
            ...
            ***REMOVED***;
            ...
            expect(result.g).to.deep.equal({ h: 5 ***REMOVED***);
            done();
        ***REMOVED***);
    ***REMOVED***);
    ...
    describe('#mapToObject', function () {
        ...
        ***REMOVED***);
        ...
        it('should convert array of objects to existential object', function (done) {
            ...
            var keys = [{ x: 1 ***REMOVED***, { x: 2 ***REMOVED***, { x: 3 ***REMOVED***];
            var subkey = 'x';
        ...
        ***REMOVED***);
        ...
        it('should throw an Error when using assert in a test with object message', function (done) {
            ...
            ***REMOVED***;
            ...
            expect(fn).to.throw('This is {"spinal":"tap"***REMOVED***');
            done();
        ***REMOVED***);
    ...
    ***REMOVED***);
    ...
    describe('#escapeRegex', function () {
        ...
        it('should escape all special regular expression characters', function (done) {
            ...
            var a = Hoek.escapeRegex('4^f$s.4*5+-_?%=#!:@|~\\/`"(>)[<]d{***REMOVED***s,');
            expect(a).to.equal('4\\^f\\$s\\.4\\*5\\+\\-_\\?%\\=#\\!\\:@\\|~\\\\\\/`"\\(>\\)\\[<\\]d\\{\\***REMOVED***s\\,');
            done();
        ***REMOVED***);
    ***REMOVED***);
    ...
    describe('#printEvent', function () {
        ...
        it('outputs event as string', function (done) {
            ...
            var event = {
                ...
                tags: ['a', 'b', 'c'],
                data: { some: 'data' ***REMOVED***
            ***REMOVED***;

            Hoek.consoleFunc = function (string) {

                Hoek.consoleFunc = console.log;
                expect(string).to.equal('130201/063045.123, a, {"some":"data"***REMOVED***');
                done();
            ***REMOVED***;
