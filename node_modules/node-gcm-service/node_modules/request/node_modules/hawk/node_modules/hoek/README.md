...
var default = {url : "www.github.com", port : "8000", debug : true***REMOVED***

var config = Hoek.applyToDefaults(default, {port : "3000", admin : true***REMOVED***);

// In this case, config would be { url: 'www.github.com', port: '3000', debug: true, admin: true ***REMOVED***
```
...
var source = {a: 0, c: 5***REMOVED***
var source2 = {a: null, c: 5***REMOVED***

var targetArray = [1, 2, 3];
var sourceArray = [4, 5];

var newTarget = Hoek.merge(target, source);     // results in {a: 0, b: 2, c: 5***REMOVED***
newTarget = Hoek.merge(target, source2);        // results in {a: null, b: 2, c: 5***REMOVED***
newTarget = Hoek.merge(target, source2, false); // results in {a: 1, b: 2, c: 5***REMOVED***
...
var defaults = {host: "localhost", port: 8000***REMOVED***;
var options = {port: 8080***REMOVED***;

var config = Hoek.applyToDefaults(defaults, options); // results in {host: "localhost", port: 8080***REMOVED***;
...
array = [{id: 1***REMOVED***, {id: 1***REMOVED***, {id: 2***REMOVED***];

newArray = Hoek.unique(array, "id") // results in [{id: 1***REMOVED***, {id: 2***REMOVED***]
...
var array = [1,2,3];
var newObject = Hoek.mapToObject(array); // results in [{"1": true***REMOVED***, {"2": true***REMOVED***, {"3": true***REMOVED***]

array = [{id: 1***REMOVED***, {id: 2***REMOVED***];
newObject = Hoek.mapToObject(array, "id") // results in [{"id": 1***REMOVED***, {"id": 2***REMOVED***]
...
var object = {a: 1, b: 2, c: 3, d: 4***REMOVED***;

var keys = ["a", "b"];

Hoek.removeKeys(object, keys) // object is now {c: 3, d: 4***REMOVED***
...
var chain = 'a.b.c';
var obj = {a : {b : { c : 1***REMOVED******REMOVED******REMOVED***;
...
target.a(function(err, result){console.log(result)***REMOVED***         // returns 'a!'       

target.c(function(err, result){console.log(result)***REMOVED***         // returns undefined

target.b(function(err, result){console.log(result)***REMOVED***         // gives error: Object [object Object] has no method 'b'
...
Hoek.rename(obj, "a", "c");     // obj is now {c : 1, b : 2***REMOVED***
...
var a = Hoek.escapeRegex('4^f$s.4*5+-_?%=#!:@|~\\/`"(>)[<]d{***REMOVED***s,');  // returns 4\^f\$s\.4\*5\+\-_\?%\=#\!\:@\|~\\\/`"\(>\)\[<\]d\{\***REMOVED***s\,
