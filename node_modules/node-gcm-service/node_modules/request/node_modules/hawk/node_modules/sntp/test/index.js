    ...
    describe('#time', function () {
        ...
        ***REMOVED***);
        ...
        it('resolves reference IP', function (done) {
            ...
            Sntp.time({ host: 'ntp.exnet.com', resolveReference: true ***REMOVED***, function (err, time) {
        ...
        ***REMOVED***);
        ...
        it('times out on no response', function (done) {
            ...
            Sntp.time({ port: 124, timeout: 100 ***REMOVED***, function (err, time) {
        ...
        ***REMOVED***);
        ...
        it('errors on error event', function (done) {
            ...
            Dgram.createSocket = function (type) {
                ...
                process.nextTick(function () { socket.emit('error', new Error('Fake')) ***REMOVED***);
                return socket;
            ***REMOVED***;
        ...
        ***REMOVED***);
        ...
        it('times out on invalid host', function (done) {
            ...
            Sntp.time({ host: 'error', timeout: 10000 ***REMOVED***, function (err, time) {
        ...
        ***REMOVED***);
        ...
        it('fails on bad response buffer size', function (done) {
            ...
            ***REMOVED***);
            ...
            Sntp.time({ host: 'localhost', port: 49123 ***REMOVED***, function (err, time) {
    ...
    describe('#offset', function () {
        ...
        ***REMOVED***);
        ...
        it('gets the current offset from cache', function (done) {
            ...
            Sntp.offset(function (err, offset) {
                ...
                expect(offset).to.not.equal(0);
                var offset1 = offset;
                Sntp.offset({***REMOVED***, function (err, offset) {
        ...
        ***REMOVED***);
        ...
        it('fails getting the current offset on invalid server', function (done) {
            ...
            Sntp.offset({ host: 'error' ***REMOVED***, function (err, offset) {
    ...
    describe('#now', function () {
        ...
        ***REMOVED***);
        ...
        it('starts auto-sync, gets now, waits, gets again after timeout', function (done) {
            ...
            Sntp.start({ clockSyncRefresh: 100 ***REMOVED***, function () {
