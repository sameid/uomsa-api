        ...
        describe('#authenticate', function () {
            ...
            it('should parse a valid authentication header (sha1)', function (done) {
                ...
                ***REMOVED***;
                ...
                Hawk.server.authenticate(req, credentialsFunc, { localtimeOffsetMsec: 1353788437000 - Hawk.utils.now() ***REMOVED***, function (err, credentials, artifacts) {
            ...
            ***REMOVED***);
            ...
            it('should parse a valid authentication header (sha256)', function (done) {
                ...
                ***REMOVED***;
                ...
                Hawk.server.authenticate(req, credentialsFunc, { localtimeOffsetMsec: 1353832234000 - Hawk.utils.now() ***REMOVED***, function (err, credentials, artifacts) {
            ...
            ***REMOVED***);
            ...
            it('should parse a valid authentication header (host override)', function (done) {
                ...
                ***REMOVED***;
                ...
                Hawk.server.authenticate(req, credentialsFunc, { host: 'example.com', localtimeOffsetMsec: 1353788437000 - Hawk.utils.now() ***REMOVED***, function (err, credentials, artifacts) {
            ...
            ***REMOVED***);
            ...
            it('should parse a valid authentication header (host port override)', function (done) {
                ...
                ***REMOVED***;
                ...
                Hawk.server.authenticate(req, credentialsFunc, { host: 'example.com', port: 8080, localtimeOffsetMsec: 1353788437000 - Hawk.utils.now() ***REMOVED***, function (err, credentials, artifacts) {
            ...
            ***REMOVED***);
            ...
            it('should parse a valid authentication header (POST with payload)', function (done) {
                ...
                ***REMOVED***;
                ...
                Hawk.server.authenticate(req, credentialsFunc, { localtimeOffsetMsec: 1357926341000 - Hawk.utils.now() ***REMOVED***, function (err, credentials, artifacts) {
            ...
            ***REMOVED***);
            ...
            it('should fail on missing hash', function (done) {
                ...
                ***REMOVED***;
                ...
                Hawk.server.authenticate(req, credentialsFunc, { payload: 'body', localtimeOffsetMsec: 1353832234000 - Hawk.utils.now() ***REMOVED***, function (err, credentials, artifacts) {
            ...
            ***REMOVED***);
            ...
            it('should fail on a stale timestamp', function (done) {
                ...
                ***REMOVED***;
                ...
                Hawk.server.authenticate(req, credentialsFunc, {***REMOVED***, function (err, credentials, artifacts) {
