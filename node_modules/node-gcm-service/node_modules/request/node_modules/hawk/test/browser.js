        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            Hawk.server.authenticate(req, credentialsFunc, {***REMOVED***, function (err, credentials, artifacts) {
                ...
                ***REMOVED***;
                ...
                expect(Browser.client.authenticate(res, credentials, artifacts, { payload: 'some reply' ***REMOVED***)).to.equal(true);
                done();
            ***REMOVED***);
        ***REMOVED***);
    ***REMOVED***);
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            Hawk.server.authenticate(req, credentialsFunc, {***REMOVED***, function (err, credentials, artifacts) {
                ...
                ***REMOVED***;
                ...
                expect(Browser.client.authenticate(res, credentials, artifacts, { payload: 'some reply' ***REMOVED***)).to.equal(false);
                done();
            ***REMOVED***);
        ***REMOVED***);
    ***REMOVED***);
    ...
    it('should generate a header then fail authentication due to bad hash', function (done) {
        ...
        ***REMOVED***;
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            req.authorization = Browser.client.header('http://example.com:8080/resource/4?filter=a', req.method, { credentials: credentials, payload: 'hola!', ext: 'some-app-data' ***REMOVED***).field;
            Hawk.server.authenticate(req, credentialsFunc, { payload: 'byebye!' ***REMOVED***, function (err, credentials, artifacts) {
        ...
        describe('#authenticate', function () {
            ...
            it('should return false on invalid header', function (done) {
                ...
                ***REMOVED***;
                ...
                expect(Browser.client.authenticate(res, {***REMOVED***)).to.equal(false);
                done();
            ***REMOVED***);
