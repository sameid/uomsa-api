        ...
        describe('#authenticate', function () {
            ...
            it('should return false on invalid header', function (done) {
                ...
                ***REMOVED***;
                ...
                expect(Hawk.client.authenticate(res, {***REMOVED***)).to.equal(false);
                done();
            ***REMOVED***);
            ...
            ***REMOVED***);
            ...
            it('should fail on invalid WWW-Authenticate header format', function (done) {
                ...
                expect(Hawk.client.authenticate({ headers: { 'www-authenticate': header ***REMOVED*** ***REMOVED***, {***REMOVED***)).to.equal(false);
                done();
            ***REMOVED***);
            ...
            it('should fail on invalid WWW-Authenticate header format', function (done) {
                ...
                ***REMOVED***;
                ...
                expect(Hawk.client.authenticate({ headers: { 'www-authenticate': header ***REMOVED*** ***REMOVED***, credentials)).to.equal(false);
                done();
            ***REMOVED***);
        ***REMOVED***);
    ***REMOVED***);
