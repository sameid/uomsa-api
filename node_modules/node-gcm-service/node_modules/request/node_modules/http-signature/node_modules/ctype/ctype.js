 ...
 *
 * { key: { type: /type/, value*: /value/, offset*: /offset/ ***REMOVED***
 *
 ...
 */
var deftypes = {
    'uint8_t':  { read: ctReadUint8, write: ctWriteUint8 ***REMOVED***,
    'uint16_t': { read: ctReadUint16, write: ctWriteUint16 ***REMOVED***,
    'uint32_t': { read: ctReadUint32, write: ctWriteUint32 ***REMOVED***,
    'uint64_t': { read: ctReadUint64, write: ctWriteUint64 ***REMOVED***,
    'int8_t': { read: ctReadSint8, write: ctWriteSint8 ***REMOVED***,
    'int16_t': { read: ctReadSint16, write: ctWriteSint16 ***REMOVED***,
    'int32_t': { read: ctReadSint32, write: ctWriteSint32 ***REMOVED***,
    'int64_t': { read: ctReadSint64, write: ctWriteSint64 ***REMOVED***,
    'float': { read: ctReadFloat, write: ctWriteFloat ***REMOVED***,
    'double': { read: ctReadDouble, write: ctWriteDouble ***REMOVED***,
    'char': { read: ctReadChar, write: ctWriteChar ***REMOVED***,
    'char[]': { read: ctReadCharArray, write: ctWriteCharArray ***REMOVED***
***REMOVED***;
...
function ctReadUint8(endian, buffer, offset)
{
	...
	return ({ value: val, size: 1 ***REMOVED***);
***REMOVED***

function ctReadUint16(endian, buffer, offset)
{
	var val = mod_ctio.ruint16(buffer, endian, offset);
	return ({ value: val, size: 2 ***REMOVED***);
***REMOVED***

function ctReadUint32(endian, buffer, offset)
{
	var val = mod_ctio.ruint32(buffer, endian, offset);
	return ({ value: val, size: 4 ***REMOVED***);
***REMOVED***

function ctReadUint64(endian, buffer, offset)
{
	var val = mod_ctio.ruint64(buffer, endian, offset);
	return ({ value: val, size: 8 ***REMOVED***);
***REMOVED***
...
function ctReadChar(endian, buffer, offset)
{
	...
	return ({ value: res, size: 1 ***REMOVED***);
***REMOVED***
...
function ctReadCharArray(length, endian, buffer, offset)
{
	...
	return ({ value: res, size: length ***REMOVED***);
***REMOVED***
...
***REMOVED***
	...
	return ({ type: type, len: len ***REMOVED***);
***REMOVED***
...
***REMOVED***
	...
	return ({ value: ret, size: offset - baseOffset ***REMOVED***);
***REMOVED***;
