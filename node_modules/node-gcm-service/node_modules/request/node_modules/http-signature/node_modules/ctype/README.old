...
[
    { x: { type: 'int16_t' ***REMOVED******REMOVED***,
    { y: { type: 'int16_t' ***REMOVED******REMOVED***
]
...
[
    { x: { type: 'int16_t', value: 42 ***REMOVED******REMOVED***,
    { y: { type: 'int16_t', value: -23 ***REMOVED******REMOVED***
]
...
[
    { x: { type: 'int16_t' ***REMOVED******REMOVED***,
    { y: { type: 'int16_t', offset: 20 ***REMOVED******REMOVED***,
    { z: { type: 'int16_t' ***REMOVED******REMOVED***
]
...
[
    { ip_addr4: { type: 'uint8_t[4]' ***REMOVED******REMOVED***,
    { len: { type: 'uint32_t' ***REMOVED******REMOVED***,
    { data: { type: 'uint8_t[len]' ***REMOVED******REMOVED***
]
