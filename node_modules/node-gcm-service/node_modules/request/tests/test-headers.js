...
s.listen(s.port, function () {
  ...
  ***REMOVED***
  ...
  createTest({headers: {cookie: 'foo=bar'***REMOVED******REMOVED***, function (req, res) {
  ...
  ***REMOVED***)
  ...
  createTest({jar: jar, headers: {cookie: 'foo=bar'***REMOVED******REMOVED***, function (req, res) {
    assert.ok(req.headers.cookie)
  ...
  ***REMOVED***)
  ...
  createTest({***REMOVED***, function (req, res) {
    assert.ok(!req.headers.cookie)
  ***REMOVED***)
***REMOVED***)
