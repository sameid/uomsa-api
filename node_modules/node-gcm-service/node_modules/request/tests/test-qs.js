...
var req1 = request.get({ uri: 'http://www.google.com', qs: { q : 'search' ***REMOVED******REMOVED***)
setTimeout(function() {
	assert.equal('/?q=search', req1.path)
***REMOVED***, 1)

// Test replacing a querystring value
var req2 = request.get({ uri: 'http://www.google.com?q=abc', qs: { q : 'search' ***REMOVED******REMOVED***)
setTimeout(function() {
	assert.equal('/?q=search', req2.path)
***REMOVED***, 1)

// Test appending a querystring value to the ones present in the uri
var req3 = request.get({ uri: 'http://www.google.com?x=y', qs: { q : 'search' ***REMOVED******REMOVED***)
setTimeout(function() {
	assert.equal('/?x=y&q=search', req3.path)
***REMOVED***, 1)

// Test leaving a querystring alone
var req4 = request.get({ uri: 'http://www.google.com?x=y'***REMOVED***)
setTimeout(function() {
	assert.equal('/?x=y', req4.path)
***REMOVED***, 1)

// Test giving empty qs property
var req5 = request.get({ uri: 'http://www.google.com', qs: {***REMOVED******REMOVED***)
setTimeout(function(){
...
var req6 = request.get({ uri: 'http://www.google.com', qs: {***REMOVED******REMOVED***);
req6.qs({ q: "test" ***REMOVED***);
