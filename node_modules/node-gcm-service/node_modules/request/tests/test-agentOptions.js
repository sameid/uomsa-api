...
***REMOVED***).listen(6767, function () {
  ...
  var r = request('http://localhost:6767', function (e, resp, body) {
    ...
    var r2 = request('http://localhost:6767', { agentOptions: { foo: 'bar' ***REMOVED*** ***REMOVED***, function (e, resp, body) {
      assert.deepEqual(r2.agent.options, { foo: 'bar' ***REMOVED***);
