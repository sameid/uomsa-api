...
var faux_requests_made = {'http':0, 'https':0***REMOVED***
...
plain_server.listen(plain_server.port, function() {
  ...
  ***REMOVED***)
  plain_server.on('/to_https', function (req, res) {
    res.writeHead(301, {'location':'https://localhost:'+https_server.port + '/https'***REMOVED***)
    res.end()
  ***REMOVED***)
  ...
  https_server.listen(https_server.port, function() {
    ...
    ***REMOVED***)
    https_server.on('/to_plain', function (req, res) {
      res.writeHead(302, {'location':'http://localhost:'+plain_server.port + '/plain'***REMOVED***)
      res.end()
    ***REMOVED***)

    run_tests()
    run_tests({***REMOVED***)
    run_tests({'http:':faux_http***REMOVED***)
    run_tests({'https:':faux_https***REMOVED***)
    run_tests({'http:':faux_http, 'https:':faux_https***REMOVED***)
  ***REMOVED***)
***REMOVED***)
...
function run_tests(httpModules) {
  ...
  request(to_https, {'httpModules':httpModules, strictSSL:false***REMOVED***, function (er, res, body) {
    if (er) throw er
    assert.equal(body, 'https', 'Received HTTPS server body')
    done()
  ***REMOVED***)

  request(to_plain, {'httpModules':httpModules, strictSSL:false***REMOVED***, function (er, res, body) {
    if (er) throw er
