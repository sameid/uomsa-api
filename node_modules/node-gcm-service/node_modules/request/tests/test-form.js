...
var FIELDS = [
  {name: 'my_field', value: 'my_value'***REMOVED***,
  {name: 'my_buffer', value: new Buffer([1, 2, 3])***REMOVED***,
  {name: 'my_file', value: fs.createReadStream(__dirname + '/unicycle.jpg')***REMOVED***,
  {name: 'remote_file', value: request(remoteFile) ***REMOVED***
];
