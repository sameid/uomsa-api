...
s.listen(s.port, function () {
  ...
  ***REMOVED***
  ...
  request({uri: server+'/perm', jar: jar, headers: {cookie: 'foo=bar'***REMOVED******REMOVED***, function (er, res, body) {
    if (er) throw er
  ...
  ***REMOVED***)
  ...
  // Temporary bounce
  request({uri: server+'/temp', jar: jar, headers: {cookie: 'foo=bar'***REMOVED******REMOVED***, function (er, res, body) {
    if (er) throw er
    if (res.statusCode !== 200) throw new Error('Status is not 200: '+res.statusCode)
  ...
  ***REMOVED***)
  ...
  // Prevent bouncing.
  request({uri:server+'/nope', jar: jar, headers: {cookie: 'foo=bar'***REMOVED***, followRedirect:false***REMOVED***, function (er, res, body) {
    if (er) throw er
  ...
  ***REMOVED***)
  ...
  request.post(server+'/temp', { jar: jar, headers: {cookie: 'foo=bar'***REMOVED******REMOVED***, function (er, res, body) {
    if (er) throw er
  ...
  ***REMOVED***)
  ...
  request.post({uri:server+'/temp', followAllRedirects:true, jar: jar, headers: {cookie: 'foo=bar'***REMOVED******REMOVED***, function (er, res, body) {
    if (er) throw er
    if (res.statusCode !== 200) throw new Error('Status is not 200: '+res.statusCode)
    assert.ok(hits.temp, 'Original request is to /temp')
    assert.ok(hits.temp_landing, 'Forward to temporary landing URL')
  ...
  ***REMOVED***)
  ...
  request.post({uri:server+'/temp', followAllRedirects:false, jar: jar, headers: {cookie: 'foo=bar'***REMOVED******REMOVED***, function (er, res, body) {
    if (er) throw er
    if (res.statusCode !== 301) throw new Error('Status is not 301: '+res.statusCode)
    assert.ok(hits.temp, 'Original request is to /temp')
  ...
  ***REMOVED***)
  ...
  request.del(server+'/temp', { jar: jar, headers: {cookie: 'foo=bar'***REMOVED******REMOVED***, function (er, res, body) {
    if (er) throw er
  ...
  ***REMOVED***)
  ...
  request.del(server+'/temp', { followRedirect: true, jar: jar, headers: {cookie: 'foo=bar'***REMOVED******REMOVED***, function (er, res, body) {
    if (er) throw er
    if (res.statusCode !== 301) throw new Error('Status is not 301: '+res.statusCode)
    assert.ok(hits.temp, 'Original request is to /temp')
    assert.ok(!hits.temp_landing, 'No chasing the redirect when delete')
  ...
  ***REMOVED***)
  ...
  request.del(server+'/temp', {followAllRedirects:true, jar: jar, headers: {cookie: 'foo=bar'***REMOVED******REMOVED***, function (er, res, body) {
    if (er) throw er
    if (res.statusCode !== 200) throw new Error('Status is not 200: '+res.statusCode)
    assert.ok(hits.temp, 'Original request is to /temp')
    assert.ok(hits.temp_landing, 'Forward to temporary landing URL')
