      ...
      for (i = p; i < len; ++i) {
        ...
        ***REMOVED***
        if (this._checkingBytes && this._bytesKey === this.fieldNameSizeLimit) {
          this._hitLimit = true;
          break;
        ***REMOVED*** else if (this._checkingBytes)
          ++this._bytesKey;
      ***REMOVED***
      ...
      if (idxeq !== undefined) {
        ...
        p = idxeq + 1;
      ***REMOVED*** else if (idxamp !== undefined) {
        ...
        ***REMOVED***
        ...
        if (this._fields === this.fieldsLimit)
          return cb();
      ***REMOVED*** else if (this._hitLimit) {
...
UrlEncoded.prototype.end = function() {
  ...
  if (this._state === 'key' && this._key.length > 0) {
    this.boy.emit('field', decodeText(this._key, 'binary', this.charset),
                           ...
                           this._keyTrunc,
                           false);
  ***REMOVED*** else if (this._state === 'val') {
    this.boy.emit('field', decodeText(this._key, 'binary', this.charset),
                           decodeText(this._val, 'binary', this.charset),
                           this._keyTrunc,
                           this._valTrunc);
