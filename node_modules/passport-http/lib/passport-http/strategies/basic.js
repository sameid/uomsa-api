 ...
 *         User.findOne({ username: userid, password: password ***REMOVED***, function (err, user) {
 *           done(err, user);
 *         ***REMOVED***);
 *       ***REMOVED***
 *     ));
...
BasicStrategy.prototype.authenticate = function(req) {
  ...
  if (!/Basic/i.test(scheme)) { return this.fail(this._challenge()); ***REMOVED***
  if (credentials.length < 2) { return this.fail(400); ***REMOVED***
