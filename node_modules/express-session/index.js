...
function session(options){
  ...
  ***REMOVED***;
  ...
  store.on('disconnect', function(){ storeReady = false; ***REMOVED***);
  store.on('connect', function(){ storeReady = true; ***REMOVED***);
 ...
 * @param {Boolean***REMOVED*** [trustProxy]
