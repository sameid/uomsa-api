...
app.get('/products/:id', function(req, res, next){
  res.json({msg: 'This is CORS-enabled for all origins!'***REMOVED***);
***REMOVED***);
...
app.get('/products/:id', cors(corsOptions), function(req, res, next){
  res.json({msg: 'This is CORS-enabled for only example.com.'***REMOVED***);
***REMOVED***);
...
app.get('/products/:id', cors(corsOptions), function(req, res, next){
  res.json({msg: 'This is CORS-enabled for a whitelisted domain.'***REMOVED***);
***REMOVED***);
...
var corsOptionsDelegate = function(req, callback){
  ...
  if(whitelist.indexOf(req.header('Origin')) !== -1){
    corsOptions = { origin: true ***REMOVED***; // reflect (enable) the requested origin in the CORS response
  ***REMOVED***else{
    corsOptions = { origin: false ***REMOVED***; // disable CORS for this request
  ***REMOVED***
